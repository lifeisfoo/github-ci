...
const DOCKER_BUILD_ARGS = process.env.DOCKER_BUILD_ARGS.split(',').reduce((acc, cur) => {
...
const REPOS_SKIP_TEST_AND_SKIP_PUSH = process.env.REPOS_SKIP_TEST_AND_SKIP_PUSH.split(',');
